...
def movdepcabinf_listar(request):
    ...
    if movdepcab.exists() :
        movdepcab = movdepcab.filter(depentrada__contains=depentrada)
    if movdepcab.exists() :
        movdepcab = movdepcab.filter(depsalida__contains=depsalida)
...
def movdepdetinf_listar(request):
    ...
    if movdepcab.exists() and depsalida:
        compracab = movdepcab.filter(depsalida=depsalida)
    if movdepcab.exists() and depsalida:
        depentrada = movdepcab.filter(depentrada=depentrada)
...
def movdepdetinfpdf(request):
    ...
    if movdepcab.exists() and fechafin:
        ...
        movdepcab = movdepcab.filter(fecha__lte=fecha_fin)
    if movdepcab.exists() and depsalida:
        movdepcab = movdepcab.filter(depsalida=depsalida)
    if movdepcab.exists() and depsalida:
        movdepcab = movdepcab.filter(depentrada=depentrada)
