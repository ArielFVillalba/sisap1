...
if ($.fn.DataTable.isDataTable('#ventalst')) {
    $('#ventalst').DataTable().destroy();
}
crearcmbtipodlist();
}
...
pag="";
if (tipolist=="general"){
if (web=="pdf"){ pag="/ventacabinfpdf/"; }
if (web=="excel"){ pag="/ventacabinfexcel/"; }
if (web=="csv"){ pag="/ventacabinfcsv/"; }
if (web=="imp"){ pag="/ventacabinfimp/"; }
};
if (tipolist=="detallado"){
if (web=="pdf"){ pag="/ventadetinfpdf/"; }
if (web=="excel"){ pag="/ventadetinfexcel/"; }
if (web=="csv"){ pag="/ventadetinfcsv/"; }
if (web=="imp"){ pag="/ventacabinfimp/"; }
};
...
if (web=="web" && tipolist=="general"){ pag="/ventacabinf_listar/"; }
if (web=="web" && tipolist=="detallado"){ pag="/ventadetinf_listar/"; }
...
$.ajax({
     ...
     var list = data.datos;
     if (web=="web" && tipolist=="general"){ listarventa(list);   }
     if (web=="web" && tipolist=="detallado") { listarventadet(list);}

}});
}
}

function listarventa(list){
lin=0;
e=0;
    var html = '';
    if ($.fn.DataTable.isDataTable('#ventalst')) {
...
html+=' <thead>  <tr> ';
html+=' <th>fecha</th> <th>factura</th> <th>cliente</th> <th>tipodoc</th> <th>total </th> ';
html+=' </tr> </thead>   ';
...
html+=" <th>"+ venta.fecha  +"</th> <th>"+ venta.nrofactura +"</th>";
...
html+=' <thead>  <tr> ';
html+=' <th>fecha</th> <th>factura</th> <th>cliente</th> <th>orden</th> <th>codigo </th> ';
...
$('#ventalst th').css({'font-size':'12px'});
$('#ventalst thead th').css({'font-size':'12'});
