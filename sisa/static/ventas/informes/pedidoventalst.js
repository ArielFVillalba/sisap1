...
if ($.fn.DataTable.isDataTable('#pedidodeventalst')) {
    $('#pedidodeventalst').DataTable().destroy();
}
crearcmbtipodlist();
}
...
function listadopedidoventaexport(web){
...
if (tipolist=="general"){
if (web=="pdf"){ pag="/pedidodeventacabinfpdf/"; }
if (web=="excel"){ pag="/pedidodeventacabinfexcel/"; }
if (web=="csv"){ pag="/pedidodeventacabinfcsv/"; }
if (web=="imp"){ pag="/pedidodeventacabinfimp/"; }
};
if (tipolist=="detallado"){
if (web=="pdf"){ pag="/pedidodeventadetinfpdf/"; }
if (web=="excel"){ pag="/pedidodeventadetinfexcel/"; }
if (web=="csv"){ pag="/pedidodeventadetinfcsv/"; }
if (web=="imp"){ pag="/pedidodeventacabinfimp/"; }
};
valida=true;
if (valida==true){
...
function listadopedidoventa(web){
...
if (web=="web" && tipolist=="general"){ pag="/pedidodeventacabinf_listar/"; }
if (web=="web" && tipolist=="detallado"){ pag="/pedidodeventadetinf_listar/"; }
...
$.ajax({
     ...
     var list = data.datos;
     if (web=="web" && tipolist=="general"){ listarpedidodeventa(list);   }
     if (web=="web" && tipolist=="detallado") { listarpedidodeventadet(list);}

}});
}
}

function listarpedidodeventa(list){
lin=0;
e=0;
    var html = '';
    if ($.fn.DataTable.isDataTable('#pedidodeventalst')) {
...
html+=' <thead>  <tr> ';
html+=' <th>fecha</th> <th>nro pedido</th> <th>cliente</th> <th>tipodoc</th> <th>total </th> ';
html+=' </tr> </thead>   ';
...
html+=" <th>"+ venta.fecha  +"</th> <th>"+ venta.nropedido +"</th>";
...
$('#pedidodeventalst').html(html);
$('#pedidodeventalst').DataTable({
lengthMenu:[20],
searching: false,
columnDefs:[
...
function listarpedidodeventadet(list){
lin=0;
e=0;
    var html = '';
    if ($.fn.DataTable.isDataTable('#pedidodeventalst')) {
...
html+=' <thead>  <tr> ';
html+=' <th>fecha</th> <th>nro pedido</th> <th>cliente</th> <th>orden</th> <th>codigo </th> ';
...
$('#pedidodeventalst th').css({'font-size':'12px'});
$('#pedidodeventalst thead th').css({'font-size':'12'});
