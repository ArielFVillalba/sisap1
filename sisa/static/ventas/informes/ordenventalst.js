...
if ($.fn.DataTable.isDataTable('#ordenventalst')) {
    $('#ordenventalst').DataTable().destroy();
}
crearcmbtipodlist();
}
...
if (tipolist=="general"){
if (web=="pdf"){ pag="/ordendeventacabinfpdf/"; }
if (web=="excel"){ pag="/ordendeventacabinfexcel/"; }
if (web=="csv"){ pag="/ordendeventacabinfcsv/"; }
if (web=="imp"){ pag="/ordendevenetacabinfimp/"; }
};
if (tipolist=="detallado"){
if (web=="pdf"){ pag="/ordendeventadetinfpdf/"; }
if (web=="excel"){ pag="/ordendeventadetinfexcel/"; }
if (web=="csv"){ pag="/ordendeventadetinfcsv/"; }
if (web=="imp"){ pag="/ordendevetacabinfimp/"; }
};
valida=true;
if (valida==true){
...
function listadoordenventa(web){
if (web=="web"){
...
if (web=="web" && tipolist=="general"){ pag="/ordendeventacabinf_listar/"; }
if (web=="web" && tipolist=="detallado"){ pag="/ordendeventadetinf_listar/"; }
...
$.ajax({
     ...
     var list = data.datos;
     if (web=="web" && tipolist=="general"){ listarordendeventa(list);   }
     if (web=="web" && tipolist=="detallado") { listarordendeventadet(list);}

}});
}
}

function listarordendeventa(list){
lin=0;
e=0;
    var html = '';
    if ($.fn.DataTable.isDataTable('#ordenventalst')) {
...
html+=' <thead>  <tr> ';
html+=' <th>fecha</th> <th>ORDEN</th> <th>cliente</th> <th>tipodoc</th> <th>total </th> ';
html+=' </tr> </thead>   ';
...
html+=" <th>"+ venta.fecha  +"</th> <th>"+ venta.nroorden +"</th>";
...
$('#ordenventalst').html(html);
$('#ordenventalst').DataTable({
lengthMenu:[20],
searching: false,
columnDefs:[
...
function listarordendeventadet(list){
lin=0;
e=0;
    var html = '';
    if ($.fn.DataTable.isDataTable('#ordenventalst')) {
...
html+=' <thead>  <tr> ';
html+=' <th>fecha</th> <th>nro orden</th> <th>cliente</th> <th>orden</th> <th>codigo </th> ';
...
$('#ordenventalst th').css({'font-size':'12px'});
$('#ordenventalst thead th').css({'font-size':'12'});
