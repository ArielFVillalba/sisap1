...
if ($.fn.DataTable.isDataTable('#notadedebitodeventalst')) {
    $('#notadedebitodeventalst').DataTable().destroy();
}
crearcmbtipodlist();
}
...
function lstnotadebventaexp(web){
...
if (tipolist=="general"){
if (web=="pdf"){ pag="/notadebitodeventacabinfpdf/"; }
if (web=="excel"){ pag="/notadebitodeventacabinfexcel/"; }
if (web=="csv"){ pag="/notadebitodeventacabinfcsv/"; }
if (web=="imp"){ pag="/notadebitodeventacabinfimp/"; }
};
if (tipolist=="detallado"){
if (web=="pdf"){ pag="/notadebitodeventadetinfpdf/"; }
if (web=="excel"){ pag="/notadebitodeventadetinfexcel/"; }
if (web=="csv"){ pag="/notadebitodeventadetinfcsv/"; }
if (web=="imp"){ pag="/notadebitodeventacabinfimp/"; }
};
valida=true;
if (valida==true){
...
function notadedebitodeventalst(web){
if (web=="web"){
...
if (web=="web" && tipolist=="general"){ pag="/notadebitodeventacabinf_listar/"; }
if (web=="web" && tipolist=="detallado"){ pag="/notadebitodeventadetinf_listar/"; }
valida=true;
if (valida==true){
...
$.ajax({
     ...
     var list = data.datos;
     if (web=="web" && tipolist=="general"){ listarnotadebdeventa(list);   }
     if (web=="web" && tipolist=="detallado") { listarnotadebdeventadet(list);}

}});
}
}

function listarnotadebdeventa(list){
lin=0;
e=0;
    var html = '';
    if ($.fn.DataTable.isDataTable('#notadedebitodeventalst')) {
...
var venta = list[i];
html+=' <tr> ';
html+=" <th>"+ venta.fecha  +"</th> <th>"+ venta.nrodebito +"</th>";
html+=' <th>'+ venta.proveedor +'</th><th>'+ venta.tipodoc +'</th>';
html+=' <th>'+ venta.total +'</th> ';
html+=' </tr>   ';
}
html+='</tbody>   ';

$('#notadedebitodeventalst').html(html);
$('#notadedebitodeventalst').DataTable({
lengthMenu:[20],
searching: false,
columnDefs:[
...
function listarnotadebdeventadet(list){
lin=0;
e=0;
...
html+=' <thead>  <tr> ';
html+=' <th>fecha</th> <th>nro notav </th> <th>cliente</th> <th>orden</th> <th>codigo </th> ';
...
$('#notadedebitodeventalst th').css({'font-size':'12px'});
$('#notadedebitodeventalst thead th').css({'font-size':'12'});
