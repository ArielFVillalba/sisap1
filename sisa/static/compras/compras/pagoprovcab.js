...
for (var i = 0; i < list.length; i++) {
      ...
      html += '<div class ="campbtn" > <button  class="btnlstdet" onClick="editarcompradet('+ pagofact.orden +')" >  EDITAR </button> ';
      html += '	<a class="btn" href="/pagoprovfact/'+pagofact.pkfd+'/eliminar/" >ELIMINAR</a>';
...
for (var i = 0; i < list.length; i++) {
      ...
      html += '	<a class="btn" href="/pagoprovpago/'+pago.pkpf+'/eliminar/" >ELIMINAR</a>';
      html += '</div> ';
      html += '</div> ';
      html += '</div> ';
