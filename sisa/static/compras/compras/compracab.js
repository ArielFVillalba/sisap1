...
for (var i = 0; i < list.length; i++) {
      ...
      html += '<div class ="campdescr" > <input id="descripcion'+ e +'"  list="descrip_list"  value=" '+ compradet.descripcion + '"</input> </div>';
      html += '</div> ';
...
function listadoagregardetalle(lin,e){
      ...
      html += '<div class ="camplst" >   <input type="text"   id="codigo" placeholder ="ingresar codigo" onkeyup="buscdatosartcod(event)"> </input> </div>';
