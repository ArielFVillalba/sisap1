...
pag="";
if (tipolist=="general"){
if (web=="pdf"){ pag="/compracabinfpdf/"; }
if (web=="excel"){ pag="/compracabinfexcel/"; }
if (web=="csv"){ pag="/compracabinfcsv/"; }
...
if (web=="web" && tipolist=="general"){ pag="/compracabinf_listar/"; }
if (web=="web" && tipolist=="detallado"){ pag="/compradetinf_listar/"; }
...
$.ajax({
     ...
     var list = data.datos;
     if (web=="web" && tipolist=="general"){ listarcompra(list);   }
     if (web=="web" && tipolist=="detallado") { listarcompradet(list);}

}});
}
}

function listarcompra(list){
lin=0;
e=0;
    var html = '';
    if ($.fn.DataTable.isDataTable('#compralst')) {
...
html+=' <thead>  <tr> ';
html+=' <th>fecha</th> <th>factura</th> <th>proveedor</th> <th>tipodoc</th> <th>total </th> ';
html+=' </tr> </thead>   ';
