...
if ($.fn.DataTable.isDataTable('#presupdecompralst')) {
    $('#presupdecompralst').DataTable().destroy();
}
crearcmbtipodlist();
}
...
function listadopedidocompraexport(web){
...
if (tipolist=="general"){
if (web=="pdf"){ pag="/pedidodecompracabinfpdf/"; }
if (web=="excel"){ pag="/pedidodecompracabinfexcel/"; }
if (web=="csv"){ pag="/pedidpdecompracabinfcsv/"; }
if (web=="imp"){ pag="/pedidodecompracabinfimp/"; }
};
if (tipolist=="detallado"){
if (web=="pdf"){ pag="/pedidodecompradetinfpdf/"; }
if (web=="excel"){ pag="/pedidodecompradetinfexcel/"; }
if (web=="csv"){ pag="/pedidodecompradetinfcsv/"; }
if (web=="imp"){ pag="/pedidodecompracabinfimp/"; }
};
valida=true;
if (valida==true){
...
function listadopedidocompra(web){
...
if (web=="web" && tipolist=="general"){ pag="/pedidodecompracabinf_listar/"; }
if (web=="web" && tipolist=="detallado"){ pag="/pedidodecompradetinf_listar/"; }
...
$.ajax({
     ...
     var list = data.datos;
     if (web=="web" && tipolist=="general"){ listarpedidodecompra(list);   }
     if (web=="web" && tipolist=="detallado") { listarpedidodecompradet(list);}

}});
}
}

function listarpedidodecompra(list){
lin=0;
e=0;
    var html = '';
    if ($.fn.DataTable.isDataTable('#pedidodecompralst')) {
        $('#pedidodecompralst').DataTable().destroy();
    }
html+=' <thead>  <tr> ';
html+=' <th>fecha</th> <th>nro pedido</th> <th>proveedor</th> <th>tipodoc</th> <th>total </th> ';
html+=' </tr> </thead>   ';
...
html+=" <th>"+ compra.fecha  +"</th> <th>"+ compra.nropedido +"</th>";
...
$('#pedidodecompralst').html(html);
$('#pedidodecompralst').DataTable({
lengthMenu:[20],
searching: false,
columnDefs:[
...
function listarpedidodecompradet(list){
lin=0;
e=0;
    var html = '';
    if ($.fn.DataTable.isDataTable('#pedidodecompralst')) {
...
html+=' <thead>  <tr> ';
html+=' <th>fecha</th> <th>nro orden</th> <th>proveedor</th> <th>orden</th> <th>codigo </th> ';
...
var compra = list[i];
html+=' <tr> ';
html+=" <th>"+ compra.fecha  +"</th> <th>"+ compra.nropresupuesto +"</th>";
...
$('#pedidodecompralst th').css({'font-size':'12px'});
$('#pedidodecompralst thead th').css({'font-size':'12'});
