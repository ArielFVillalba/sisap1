...
if ($.fn.DataTable.isDataTable('#ordencompralst')) {
    $('#ordencompralst').DataTable().destroy();
}
crearcmbtipodlist();
}
...
if (tipolist=="general"){
if (web=="pdf"){ pag="/ordendecompracabinfpdf/"; }
if (web=="excel"){ pag="/ordendecompracabinfexcel/"; }
if (web=="csv"){ pag="/ordendecompracabinfcsv/"; }
if (web=="imp"){ pag="/ordendecompracabinfimp/"; }
};
if (tipolist=="detallado"){
if (web=="pdf"){ pag="/ordendecompradetinfpdf/"; }
if (web=="excel"){ pag="/ordendecompradetinfexcel/"; }
if (web=="csv"){ pag="/ordendecompradetinfcsv/"; }
if (web=="imp"){ pag="/ordendecompracabinfimp/"; }
};
valida=true;
if (valida==true){
...
function listadoordencompra(web){
if (web=="web"){
...
if (web=="web" && tipolist=="general"){ pag="/ordendecompracabinf_listar/"; }
if (web=="web" && tipolist=="detallado"){ pag="/ordendecompradetinf_listar/"; }
...
$.ajax({
     ...
     var list = data.datos;
     if (web=="web" && tipolist=="general"){ listarordendecompra(list);   }
     if (web=="web" && tipolist=="detallado") { listarordendecompradet(list);}

}});
}
}

function listarordendecompra(list){
lin=0;
e=0;
    var html = '';
    if ($.fn.DataTable.isDataTable('#ordencompralst')) {
...
html+=' <thead>  <tr> ';
html+=' <th>fecha</th> <th>ORDEN</th> <th>proveedor</th> <th>tipodoc</th> <th>total </th> ';
html+=' </tr> </thead>   ';
...
html+=" <th>"+ compra.fecha  +"</th> <th>"+ compra.nroorden +"</th>";
...
$('#ordencompralst').html(html);
$('#ordencompralst').DataTable({
lengthMenu:[20],
searching: false,
columnDefs:[
...
function listarordendecompradet(list){
lin=0;
e=0;
    var html = '';
    if ($.fn.DataTable.isDataTable('#ordencompralst')) {
...
$('#ordencompralst th').css({'font-size':'12px'});
$('#ordencompralst thead th').css({'font-size':'12'});
