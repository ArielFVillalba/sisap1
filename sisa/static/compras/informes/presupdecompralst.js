...
if (tipolist=="general"){
if (web=="pdf"){ pag="/presupdecompracabinfpdf/"; }
if (web=="excel"){ pag="/presupdecompracabinfexcel/"; }
if (web=="csv"){ pag="/presupdecompracabinfcsv/"; }
if (web=="imp"){ pag="/presupdecompracabinfimp/"; }
};
if (tipolist=="detallado"){
if (web=="pdf"){ pag="/presupdecompradetinfpdf/"; }
if (web=="excel"){ pag="/presupdecompradetinfexcel/"; }
if (web=="csv"){ pag="/presupdecompradetinfcsv/"; }
if (web=="imp"){ pag="/presupdecompracabinfimp/"; }
};
valida=true;
if (valida==true){
...
function listadopresupcompra(web){
if (web=="web"){
...
if (web=="web" && tipolist=="general"){ pag="/presupdecompracabinf_listar/"; }
if (web=="web" && tipolist=="detallado"){ pag="/presupdecompradetinf_listar/"; }
...
$.ajax({
     ...
     var list = data.datos;
     if (web=="web" && tipolist=="general"){ listarpresupdecompra(list);   }
     if (web=="web" && tipolist=="detallado") { listarpresupdecompradet(list);}

}});
}
}

function listarpresupdecompra(list){
lin=0;
e=0;
    var html = '';
...
html+=' <thead>  <tr> ';
html+=' <th>fecha</th> <th>nropresupuesto</th> <th>proveedor</th> <th>tipodoc</th> <th>total </th> ';
html+=' </tr> </thead>   ';
...
$('#presupdecompralst').html(html);
$('#presupdecompralst').DataTable({
lengthMenu:[20],
searching: false,
columnDefs:[
...
function listarpresupdecompradet(list){
lin=0;
e=0;
    var html = '';
    if ($.fn.DataTable.isDataTable('#presupdecompralst')) {
...
html+=' <thead>  <tr> ';
html+=' <th>fecha</th> <th>nro presupuesto</th> <th>proveedor</th> <th>orden</th> <th>codigo </th> ';
...
$('#presupdecompralst th').css({'font-size':'12px'});
$('#presupdecompralst thead th').css({'font-size':'12'});
